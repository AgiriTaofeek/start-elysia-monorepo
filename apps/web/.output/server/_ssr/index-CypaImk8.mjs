...
import { s as se } from "../_chunks/_libs/@elysiajs/eden.mjs";
function r(e) {
  var t, f, n = "";
...
const env$1 = createEnv({
  server: {
    ...
    PORT: coerce.number().default(4e3),
    NODE_ENV: enumType(["development", "production", "test"]).default("development"),
    BETTER_AUTH_SECRET: stringType().min(1),
    BETTER_AUTH_URL: stringType().url()
  },
  client: {
    VITE_BETTER_AUTH_URL: stringType().url().optional(),
    VITE_API_URL: stringType().url().optional()
  },
  runtimeEnv: process.env,
  clientPrefix: "VITE_",
  skipValidation: !!process.env.SKIP_ENV_VALIDATION || false || !!process.env.CI
});
const env = env$1;
const api = se(env.VITE_API_URL ?? "http://localhost:4000");
function App() {
  const [health, setHealth] = reactExports.useState("checking...");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-svh p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex max-w-md min-w-0 flex-col gap-4 text-sm leading-loose", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground", children: [
      "API status: ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: health })
    ] }),
